                ...
                <div class="row">
                    <div class="col-md-6">
                        <h4>
                            verifikasi 
                            <small>
                                <a href="" data-toggle="modal" data-target="#verifikasiModal">
  ...
  <div class="modal fade" id="verifikasiModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <form action="/admin/produk/{{$produk->kd_produk}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                        <option value="1">Produk valid</option>
                        <option value="2">Produk tidak valid</option>
                    </select>
                </div>
            </div>
